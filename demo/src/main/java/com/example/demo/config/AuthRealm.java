...
// import com.example.demo.cache.DBCache;
...
public class AuthRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token)
        ...
        User user = Optional.ofNullable(userMapper.selectUserByName(principal)).orElseThrow(UnknownAccountException::new);
        if (user.isLocked()) {
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principal) {
        ...
        Map<String, Collection<String>> permissionsCache = new HashMap<>();
        for (Role role : userMapper.listRoles()) {
            permissionsCache.put(role.getRoleName(), role.getPermissions());
        }
